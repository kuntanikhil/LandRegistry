...
def register_land(account, land_id, location, area):
    try:
        ...
        print(f"Error during land registration: {str(e)}")
...
def transfer_ownership(account, land_id, new_owner):
    try:
        ...
        print(f"Error during ownership transfer: {str(e)}")
        return f"Error: {str(e)}"
...
def get_land_details(land_id):
    try:
        ...
        print(f"Error fetching land details: {str(e)}")
        return {"Error": str(e)}
...
def is_land_registered(land_id):
    try:
        ...
        print(f"Error checking land registration: {str(e)}")
        return f"Error: {str(e)}"
